...
export const suppliers: SupplierSeed[] = [
  ...
  { code: 'NCC-17', name: 'Công ty cổ phần thực phẩm Sunfood Tây Đô', sourceUrl: 'https://truyxuat.smartcheck.vn/check/3324', productName: 'Sản phẩm giò chả', address: 'Số 17-19 Khu TT Cầu 1, đường Phan Bá Vành, phường Đông Ngạc, TP Hà Nội', taxCode: '0110716043' },
