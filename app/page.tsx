...
export default async function Home() {
  ...
  return <main className="home-page"><header className="home-nav"><div className="trace-logo"><span>SF</span><div><b>SUNFOOD TÂY ĐÔ</b><small>Thực phẩm an toàn mỗi ngày</small></div></div><Link href="/admin" className="admin-link">Quản trị</Link></header>
    <TraceabilityHero />
    ...
    <footer className="trace-footer"><b>CÔNG TY CỔ PHẦN THỰC PHẨM SUNFOOD TÂY ĐÔ</b><p>MST 0110716043 · Số 17-19 Khu TT Cầu 1, đường Phan Bá Vành, phường Đông Ngạc, TP Hà Nội</p></footer>
  </main>
}
